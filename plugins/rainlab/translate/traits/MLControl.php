...
namespace RainLab\Translate\Traits;
...
{
    /**
     * @var bool isAvailable determines whether translation services are available
     */
    public $isAvailable;
     ...
     *
     * @param  bool  $switch Defaults to true, determines whether to act as the parent or revert to current
     */
