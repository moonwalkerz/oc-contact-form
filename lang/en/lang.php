...
return [
    "contactform" => [
        ...
        "name_placeholder" => "Insert your name and surname Ex: Mario Rossi",
        "phone" => "Phone",
    ...
    "plugin" => [
        ...
        "name" => "Contacts",
        "sw_contact" => "Contactable",
        "sw_promo" => "Promo",
        "sw_third_parties" => "Third parties",
    ...
    "settings" => [
        "captcha" => "Captcha Type",
        "captcha_invisible" => "Invisible",
        "captcha_none" => "None",
        ...
        "google_api_key" => "Google site key",
        ...
        "txt_promo_text1" => "I agree to receive direct marketing emails/communications from",
        "txt_promo_text2" => " in accordance with the Privacy Policy.",
